...
export default function Login() {
  ...
  return (
    <div style={{ minHeight:'calc(100vh - 64px)', display:'flex', alignItems:'center', justifyContent:'center', padding:'24px 16px', position:'relative' }}>
      ...
      {/* Background glow */}
      <div style={{ position:'fixed', top:'30%', left:'50%', transform:'translate(-50%,-50%)', width:600, height:600, borderRadius:'50%', background:'radial-gradient(circle, rgba(124,58,237,0.12) 0%, transparent 70%)', pointerEvents:'none' }} />
      ...
      >
        <div style={{ background:'rgba(8,2,35,0.92)', backdropFilter:'blur(20px)', border:'1px solid rgba(245,200,66,0.18)', borderRadius:24, padding:'clamp(24px,5vw,40px)', boxShadow:'0 24px 64px rgba(0,0,0,0.6)' }}>
          ...
          <div style={{ textAlign:'center', marginBottom:32 }}>
            ...
            <h1 style={{ fontFamily:"'Syne',sans-serif", fontSize:28, fontWeight:800, color:'#fff', marginBottom:6 }}>Welcome back</h1>
            <p style={{ fontSize:14, color:'rgba(200,180,255,0.6)' }}>Sign in to your ShopEasy account</p>
          </div>
